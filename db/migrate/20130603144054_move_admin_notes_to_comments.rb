class MoveAdminNotesToComments < ActiveRecord::Migration
  def self.up
    ...
    # Update all the existing blog_comments to the default namespace
    say "Updating any existing blog_comments to the #{ActiveAdmin.application.default_namespace} namespace."
